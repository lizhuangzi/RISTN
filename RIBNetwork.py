...
class RIBNet(nn.Module):
    def __init__(self, nblock=[6,8,10,10],nblock2=[6,6,12,6],INi=[3,16,64,256]):
        super(RIBNet, self).__init__()
        self.nblock = nblock;
        ...
        self.resblock1 = RIB(layercount=nblock[0],inchannel=16,outchannel=8,first_initpad=True)
        self.resblock1_1 = RIB(layercount=nblock[0], inchannel=16, outchannel=8, first_initpad=True)
        self.resblock2 = RIB(layercount=nblock[1], inchannel=32,outchannel=16,first_initpad=True)
        self.resblock2_2 = RIB(layercount=nblock2[1], inchannel=32, outchannel=16, first_initpad=True)

        self.resblock3 = RIB(layercount=nblock[2], inchannel=64, outchannel=32,first_initpad=True,pooling=False)
        self.resblock3_3 = RIB(layercount=nblock2[2], inchannel=64, outchannel=32, first_initpad=True,pooling=False)
        self.resblock4 = RIB(layercount=nblock[3], inchannel=128, outchannel=64, first_initpad=True)
        self.resblock4_4 = RIB(layercount=nblock2[3], inchannel=128, outchannel=64, first_initpad=True)
